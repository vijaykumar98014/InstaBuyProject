...
const ConfirmModal = memo(function ConfirmModal({ orderId, onConfirm, onCancel }) {
  return (
...
const OrderCard = memo(function OrderCard({ order, role, onCancel, onStatusUpdate, onEditOpen, onRefund, index }) {
...
function Orders() {
  ...
  const FILTERS = useMemo(() => ["ALL", "CREATED", "CONFIRMED", "SHIPPED", "DELIVERED", "CANCELLED"], []);
